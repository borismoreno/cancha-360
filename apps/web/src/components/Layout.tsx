...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill={active ? "#bcf521" : "#adaaaa"}>
    ...
    <div className="flex h-screen bg-surface overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: active ? "#bcf521" : "transparent" }}
                />
                {item.icon(active)}
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header
          ...
          style={{ backgroundColor: "rgba(32,31,31,0.75)", backdropFilter: "blur(20px)" }}
        >
          {/* Search */}
          <div className="flex-1 max-w-sm">
            <div className="flex items-center gap-2 bg-surface-highest rounded-full px-4 py-2">
              ...
              <input
                type="text"
                placeholder="Search players, drills, or teams..."
