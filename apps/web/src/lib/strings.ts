...
export const strings = {
  ...
  auth: {
    ...
    heroTagline: "Plataforma de desarrollo futbolístico",
    desktopHeroLine1: "EL PROGRESO",
    desktopHeroLine2: "DE TUS JUGADORES",
    desktopHeroLine3: "COMIENZA AQUÍ.",
    emailOrUsername: "EMAIL O USUARIO",
    emailUserPlaceholder: "atleta@cancha360.com",
    forgotPassword: "¿OLVIDÉ MI CONTRASEÑA?",
    loginArrow: "INGRESAR →",
    newToAcademy: "¿Aún no tienes acceso a una academia?",
    requestAccess: "Solicitar Acceso",
    quickAccess: "ACCESO RÁPIDO",
    welcomeBack: "Accede a tu academia",
    enterCredentials: "Ingresa tus credenciales para acceder a tu academia.",
    ...
    footerCopyright:
      "© 2026 Cancha360 · Seguimiento de rendimiento para academias de fútbol",
